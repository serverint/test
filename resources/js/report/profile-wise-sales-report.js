					...
					$("#profile-wise-sales-report")
							.submit(
									function(e) {
										...
										if (isBlank(gender, "Gender")) {
											flag = false;
										}
										
										if (isBlank(toAge, "To Age")) {
											flag = false;
										}
										
										if (isBlank(fromAge,"From Age")) {
											flag = false;
										}
										if (isBlank(toAmount, "To Amount")) {
											flag = false;
										}
										
										if (isBlank(fromAmount,	"From Amount")) {
											flag = false;
										}
