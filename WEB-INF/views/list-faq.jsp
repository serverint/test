					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty faqDetails}">
											<c:forEach items="${faqDetails}" var="data">
												<tr>
													<td></td>
													...
													<td>
														<a href="edit-faq?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														<a onclick="return deleteFaqConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
