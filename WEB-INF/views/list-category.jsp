								...
								<tbody>
									<c:choose>
										<c:when test="${not empty listCategory}">
											<c:forEach items="${listCategory}" var="data">
												<tr>
													<td></td>
													...
													<td>
														<a href="edit-category?categoryId=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
<%-- 														<a onclick="return deleteCategoryConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs"> --%>
										...
										<form style="margin-bottom: 0px !important;"
											...
											<div class="modal-body">
												...
												<div class="text-center">
													...
													<strong> this Category</strong></span> ?
												</div>
											</div>
