...
<script src="resources/js/addon-quantity/addon-quantity.js"></script>
					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty listAddOnQuantity}">
											<c:forEach items="${listAddOnQuantity}" var="data">
												<tr>
													<td></td>
													...
													<td>
														<a href="edit-addon-quantity?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														<a onclick="return deleteAddonQuantityConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<form style="margin-bottom: 0px !important;"
											...
											action="delete-addon-quantity">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												<h4 class="modal-title" id="myModalLabel">Delete Addon Quantity</h4>
												<hr />
											</div>
											<div class="modal-body">
												<input type="hidden" name="addOnQuantityId" id="addOnQuantityId" value="">
												<div class="text-center">
													<span>Are you sure, you want to <b>
													<font color="green">Delete</font> 
													<strong> this Addon Quantity</strong></span> ?
												</div>
											</div>
