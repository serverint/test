					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty listBanner}">
											<c:forEach items="${listBanner}" var="data">
												<tr>
													<td></td>
													<td>${data.lastUpdateTimeStamp }</td>
													<td>${data.note}</td>
													<td>
													  <img src="image-draw?imageName=${data.imageName}&fileType=image&viewType=view&imageType=banner" width="80px" height="80px" /> 
													</td>										
													<c:choose>
													...
													<td>
														<a href="edit-banner?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														
														<c:if test="${sessionScope.adminUserModel.adminType == 'SUPER_ADMIN'}">
															<a onclick="return deleteBannerConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
										...
										<form style="margin-bottom: 0px !important;"
											...
											<div class="modal-body">
												...
												<div class="text-center">
													...
													<strong> this Banner</strong></span> ?
												</div>
											</div>
