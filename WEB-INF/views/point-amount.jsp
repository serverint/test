				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-primary clearfix">
							<!-- /.box-header -->
							<div class="box-body">
								<form action="point-amount-save" id="point-amount-save-form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label>Point : *</label>
										 <input type="text" name="point" id="point" class="form-control" value="${loyaltyConversion.point}">
									</div>
									<div class="form-group">
										<label>Cash : *</label> 
										<input type="text" name="amount" id="amount" class="form-control" value="${loyaltyConversion.amount}">
									</div>
									...
									<div class="box-footer">		
										<input type="hidden" name="loyaltyConversionType" id="loyaltyConversionType" value="${conversionType}">								
