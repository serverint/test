					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty adminUserModels}">
											<c:forEach items="${adminUserModels}" var="data">
												<tr>
													<td></td>
													...
													<td>
														<a href="edit-admin-user?adminUserId=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														<a onclick="return adminUserDeleteConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
									...
									<div class="modal-content">
										<form style="margin-bottom: 0px !important;"
											...
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Delete Branch User</h4>
												<hr />
											</div>
											<div class="modal-body">
												<input type="hidden" name="adminUserId" id="adminUserId" value="">
												<div class="text-center">
													<span>Are you sure, you want to <b>
													<font color="green">Delete</font> 
													<strong> this Branch User</strong></span> ?
												</div>
											</div>
