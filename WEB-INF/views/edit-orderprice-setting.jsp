...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="main-body clearfix">
			<div class="cont-top">
				<h1>Add Minimum Order Amount </h1>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-primary clearfix">
							<!-- /.box-header -->
							<div class="box-body">
								<form action="edit-orderprice" id="add-orderprice-form" method="post">
									<div class="form-group">
										<label>Order Amount : <span class="mandatory-astric-color">*</span><span class="mandatory-msg">(max 8 digits)</span></label> 
										<input type="text" name="price" id="price" value="${orderPriceModel.price}" class="form-control" maxlength="8">
									</div>
									
									<div class="form-group">
										<label>Order COD Amount : <span class="mandatory-astric-color">*</span><span class="mandatory-msg">(max 8 digits)</span></label> 
