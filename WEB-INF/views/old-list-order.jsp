										...
										<c:when test="${not empty orderDetails}">
											<c:forEach items="${orderDetails}" var="data">
												<tr>
													...
													<td>${data.userModel.firstName} ${data.userModel.lastName}</td>
													...
													<td>
														<a href="edit-old-order?orderId=${data.id}" class="btn btn-default btn-xs"> 
...
<script>
	jQuery(document).ready(function($){
						...
						$('.orderstatus').change(function(event) {
											...
											//alert("valueorderType"+valueorderType)
											var valueorderTransactiontype = $(this).closest('tr').children("td")[5].innerHTML;
											//alert("valueorderTransactiontype"+valueorderTransactiontype);
											var valueorderStatus = $(this).val();
											//alert("valueorderStatus"+valueorderStatus);
											//alert(valueorderId);
