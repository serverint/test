					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty listCounrty}">
											<c:forEach items="${listCounrty}" var="data">
												<tr>
													...
													<td>
													  <img src="image-draw?imageName=${data.imageName}&fileType=image&viewType=view&imageType=country" width="80px" height="80px" /> 
													</td>												
													<c:choose>
													...
													<td>
														<a href="edit-country?id=${data.countryId}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														<a onclick="return deleteCountryConfirmation('${data.countryId}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
										...
										<form style="margin-bottom: 0px !important;"
											...
											<div class="modal-body">
												...
												<div class="text-center">
													...
													<strong> this Country</strong></span> ?
												</div>
											</div>
