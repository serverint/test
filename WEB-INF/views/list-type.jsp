										...
										<c:when test="${not empty listType}">
											<c:forEach items="${listType}" var="data">
												<tr>
													...
													<td>
														<a href="edit-type?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														<a onclick="return deleteTypeConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
