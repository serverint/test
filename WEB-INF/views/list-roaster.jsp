					...
					<div class="col-md-12">
						...
						<div class="res_table">
							<table id="dataTable"
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty roasterModels}">
											<c:forEach items="${roasterModels}" var="data">
												<tr>
													<td></td>
													...
													<td>
														<a href="edit-roaster?roasterId=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														
														<c:if test="${sessionScope.adminUserModel.adminType == 'SUPER_ADMIN'}">
															<a onclick="return deleteRosterConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
						...
						<div class="modal fade" id="deleteModal"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<form style="margin-bottom: 0px !important;" class="form-horizontal" method="POST" action="delete-roaster">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												<h4 class="modal-title" id="myModalLabel">Delete Roaster</h4>
												<hr />
											</div>
											<div class="modal-body">
												...
												<div class="text-center">
													...
													<strong> this Roaster</strong></span> ?
												</div>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" 	data-dismiss="modal">Close</button>
												<button type="submit" class="btn btn-primary">Delete Roaster</button>
											</div>
										</form>
									</div>
								</div>
