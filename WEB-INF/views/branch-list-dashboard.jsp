								...
								<tbody>
									<c:choose>
										<c:when test="${not empty listBranch}">
											<c:forEach items="${listBranch}" var="data">
												<tr>
													<td></td>
													<td>${data.lastUpdateTimeStamp}</td>
													<td>${data.branchName}</td>
													<td>${data.branchStartTime}</td>
													<td>${data.branchEndTime}</td>
													<c:choose>
													...
													<td><c:choose>
															<c:when test="${adminType == 'SUPER_ADMIN'}">
																<a href="./edit-branch?id=${data.id}"
																	class="btn btn-default btn-xs"> <i
																	class="fa fa-pencil"></i>
																</a>

																<a
																	onclick="return deleteBranchConfirmation('${data.id}');"
															...
															<c:otherwise>
																<a href="./edit-branch-dashboard?id=${data.id}"
																	class="btn btn-default btn-xs"> <i
																	class="fa fa-pencil"></i>
																</a>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<form style="margin-bottom: 0px !important;"
											class="form-horizontal" method="POST" action="delete-branch">
											...
											<div class="modal-body">
												...
												<div class="text-center">
													<span>Are you sure, you want to <b> <font
															color="green">Delete</font> <strong> this Branch</strong></span>
													?
												</div>
											</div>
