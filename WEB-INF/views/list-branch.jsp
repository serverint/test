										...
										<c:when test="${not empty listBranch}">
											<c:forEach items="${listBranch}" var="data">
												<tr>
													...
													<td>
														<a href="./edit-branch?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														
														<c:if test="${sessionScope.adminUserModel.adminType == 'SUPER_ADMIN'}">
														<a onclick="return deleteBranchConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
										...
										<form style="margin-bottom: 0px !important;"
											...
											<div class="modal-body">
												...
												<div class="text-center">
													...
													<strong> this Branch</strong></span> ?
												</div>
											</div>
