										...
										<c:when test="${not empty listUser}">
											<c:forEach items="${listUser}" var="data">
												<tr>
													...
													<td>
														<a href="edit-user?id=${data.id}" class="btn btn-default btn-xs"> 
															<i class="fa fa-pencil"></i>
														</a> 
														
														<c:if test="${sessionScope.adminUserModel.adminType == 'SUPER_ADMIN'}">
														
															<a onclick="return deleteUserConfirmation('${data.id}');" data-toggle="modal" data-target="#deleteModal"  class="btn btn-default btn-xs">
